...
| Auto-picking the group column for group-wise imputation | Step 5 | Needs a heuristic for "does this column predict that one" that the project has no basis to choose. The capability exists; the user names the column. |
